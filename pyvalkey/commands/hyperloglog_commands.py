...
@command(b"pfadd", {b"stream", b"fast"}, flags={b"write"})
...
@command(b"pfcount", {b"stream", b"fast"}, flags={b"write"})
...
@command(b"pfdebug", {b"stream", b"fast"}, flags={b"write"})
...
@command(b"pfmerge", {b"stream", b"fast"}, flags={b"write"})
...
@command(b"pfselftest", {b"stream", b"fast"}, flags={b"write"})
